...
const jaJP: TranslationDict = {
  "app.title": "UniGoDesktop",
  "app.subtitle": "UniBoot デスクトップ ブートドライブ作成エンジン",
  "mode.cloud": "モード B (1秒極速クラウドインストール)",
  "mode.hybrid": "モード A (万能ハイブリッドドライブ)",
  "disk.select_title": "ターゲット USB ドライブを選択",
  "disk.select_desc": "取り外し可能な USB ドライブのみ安全にスキャンします。システムドライブは保護されます。",
  "disk.single_mode": "🎯 単一選択",
  "disk.batch_mode": "📦 一括選択",
  "disk.select_all": "✅ すべて選択",
  "disk.clear_select": "❌ 選択解除",
  "disk.selected_count": "選択中 {count}/{total}",
  "disk.rescan": "USB ドライブを再スキャン",
  "disk.no_disk": "USB ドライブが選択されていません",
  "disk.removable": "リムーバブルドライブ",
  "disk.system_disk": "システムドライブ (保護対象)",
  "disk.fake_usb3_warning": "⚠️ 偽装 USB 3.0 ドライブの疑い (実際は USB 2.0 480 Mb/s で動作)",
  "disk.genuine_usb3": "⚡ 高速 USB 3.0+ ドライブ",
  "disk.free_space": "空き容量",
  "disk.change_icon": "アイコン変更",
  "disk.hw_inspect": "ハードウェア診断",
  "disk.details": "詳細情報",
  "disk.tag_boot": "ブートドライブ",
  ...
  "safe.desc_cloud": "モード B は UNIBOOT 2パーティション構成を保持します。ESP パーティションの更新により全 ISO およびユーザーファイルは完全保護されます！",
  "safe.title_hybrid": "既存の Ventoy ブートディスクを検出 (データ保持アップグレード)",
  "safe.desc_hybrid": "モード A はフォーマットなしで全 ISO ファイルを保持し、UniBoot ダークテーマとクラウドブートメニューを注入します！",
  "iso.title": "💿 ローカルシステムイメージソース (ISO / IMG / WIM / VHD)",
  "iso.desc": "イメージを追加すると /UNIBOOT/iso/ に自動コピーされ、Ventoy / UniBoot で直接ブート可能です。",
  "iso.add_btn": "➕ イメージファイルを追加",
  "iso.empty_title": "クリックしてイメージファイルを追加 (単一または一括選択に対応)",
  "iso.empty_sub": ".iso, .wim, .img, .vhd, .vhdx, .efi, .bin など全 Ventoy 形式に対応",
  "iso.summary": "{count} 個のイメージソースファイルを選択中",
  "iso.clear": "リストをクリア",
  "deploy.title": "ブートドライブ作成 & QEMU テスト",
  "deploy.desc_cloud": "ピュア iPXE クラウドブート • 高速2パーティション初期化 & マルチアーキテクチャ iPXE ファームウェア。",
  "deploy.desc_hybrid": "Ventoy コア統合 + UniBoot ダークテーマ & iPXE ネットワーク拡張。大容量 ISO に対応。",
  "deploy.target_device": "ターゲットデバイス:",
  "deploy.batch_target": "{count} 台の USB ドライブを選択中",
  "deploy.start_create": "作成を開始",
  "deploy.start_update": "🛡️ データ保持アップグレード",
  "deploy.batch_create": "一括作成を開始 ({count} 台)",
  ...
  "qemu.target": "テスト対象:",
  "qemu.no_disk_warn": "⚠️ USB ドライブが選択されていません",
  "qemu.run_test": "▶ QEMU テストを実行",
  ...
  "settings.default_mode": "デフォルトモード:",
  "settings.default_fs": "デフォルトファイルシステム:",
  "settings.app_update": "アップデート確認:",
  "settings.update_auto": "起動時に自動確認",
  ...
  "settings.ventoy_win11_bypass": "Bypass Windows 11 TPM/CPU/RAM Check:",
  "settings.ventoy_timeout": "Ventoy Menu Timeout (Seconds):",
  "confirm.title": "フォーマットの警告",
  "confirm.warning_title": "⚠️ 警告: フォーマットするとデータが全消去されます！",
  "confirm.warning_desc": "選択した USB ドライブを再パーティションおよびフォーマットします。データが消失しますのでバックアップを確認してください！",
  "confirm.mode_title": "Deployment Mode:",
  "confirm.fs_title": "Target File System:",
  "confirm.disks_title": "Drives to be Formatted ({count}):",
  "confirm.confirm_btn": "🔥 了解して作成開始",
  ...
  "ventoy_alert.default_title": "Cannot Create Mode A Disk",
  "ventoy_alert.banner_title": "💡 Missing Pre-requisites & Guidance",
  "inspector.title": "USB ハードウェア診断レポート",
  "inspector.subtitle": "PHY プロトコル・速度・ハードウェア解析",
  "inspector.device": "Device Node:",
  "inspector.vendor": "Vendor / Brand:",
  "inspector.bus_speed": "Bus Protocol & Speed:",
  "inspector.fake_report": "Fake USB 3.0 Analysis:",
  ...
  "inspector.ext_protocols": "Extensible Protocol Standards",
  "inspector.close": "閉じる",
  "icon_picker.title": "USB アイコンのカスタム",
  "icon_picker.reset": "リセット",
  "icon_picker.subtitle": "ターゲットドライブ {name} のアイコンを選択:",
  "icon_picker.usb_desc": "Classic SuperSpeed 5 Gbps Drive",
  "icon_picker.usb2_desc": "Classic High-Speed 480 Mbps Drive",
  "icon_picker.usb3_1_desc": "SuperSpeed+ 10 Gbps High Speed Drive",
  "icon_picker.usb3_2_desc": "Gen 2x2 20 Gbps Dual-Channel Drive",
...
const koKR: TranslationDict = {
  ...
  "disk.selected_count": "선택됨 {count}/{total}",
  "disk.rescan": "USB 다시 스캔",
  "disk.no_disk": "선택된 USB 드라이브 없음",
  "disk.removable": "이동식 드라이브",
  "disk.system_disk": "시스템 디스크 (보호됨)",
  "disk.fake_usb3_warning": "⚠️ 저속 가짜 USB 3.0 드라이브 의심 (실제 USB 2.0 480 Mb/s 동작)",
  "disk.genuine_usb3": "⚡ 고속 USB 3.0+ 드라이브",
  "disk.free_space": "여유 공간",
  "disk.change_icon": "아이콘 변경",
  "disk.hw_inspect": "하드웨어 진단",
  "disk.details": "상세 정보",
  ...
  "deploy.start_update": "🛡️ 데이터 유지 업그레이드",
