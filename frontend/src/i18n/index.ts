...
const arSA: TranslationDict = {
  ...
  "settings.ventoyPlugins": "⚡ Ventoy Plugins (ventoy.json)",
  "app.title": "UniGoDesktop",
  "app.subtitle": "محرك إنشاء أقراص التمهيد لسطح المكتب UniBoot",
  "mode.cloud": "الوضع B (قرص تثبيت سحابي خلال ثانية واحدة)",
  "mode.hybrid": "الوضع A (قرص هجين كامل)",
  "disk.select_title": "اختر محرك USB المستهدف",
  "disk.select_desc": "مسح محركات USB القابلة للإزالة بأمان. أقراص النظام محمية.",
  "disk.single_mode": "🎯 تحديد فردي",
  "disk.batch_mode": "📦 تحديد دفعة",
  "disk.select_all": "✅ تحديد الكل",
  "disk.clear_select": "❌ إلغاء التحديد",
  "disk.selected_count": "المحدد {count}/{total}",
  "disk.rescan": "إعادة مسح محركات USB",
  "disk.scanning": "جاري فحص محركات USB القابلة للإزالة...",
  "disk.no_disk": "لم يتم تحديد محرك USB",
  "disk.removable": "محرك قابل للإزالة",
  "disk.system_disk": "قرص النظام (محمي)",
  "disk.fake_usb3_warning": "⚠️ يُشتبه في أنه محرك USB 3.0 مزيف منخفض السرعة (يعمل بسرعة USB 2.0 480 Mb/s)",
  "disk.genuine_usb3": "⚡ محرك USB 3.0+ عالي السرعة",
  "disk.free_space": "المساحة المتاحة",
  "disk.change_icon": "تخصيص الأيقونة",
  "disk.hw_inspect": "فحص الأجهزة",
  "disk.details": "التفاصيل",
  "disk.tag_boot": "قرص تمهيد",
  ...
  "disk.tag_cdrom": "محرك قرص وهمي",
  "safe.title_cloud": "تم اكتشاف محرك Ventoy/UniBoot حالي (الوضع B يجدد قسم ESP فقط)",
  "safe.desc_cloud": "يحافظ الوضع B على تخطيط UNIBOOT ثنائي القسم. تحديث قسم ESP يترك جميع ملفات ISO والبيانات سليمة!",
  "safe.title_hybrid": "تم اكتشاف قرص تمهيد Ventoy حالي (تحديث بدون إزالة البيانات)",
  "safe.desc_hybrid": "يحافظ الوضع A على جميع ملفات ISO الحالية دون تهيئة، مع إدراج مظهر UniBoot الداكن وقائمة التمهيد السحابية بأمان!",
  "iso.title": "💿 مصادر صور النظام المحلية (ISO / IMG / WIM / VHD)",
  "iso.desc": "أضف ملفات ISO للنسخ التلقائي إلى دليل /UNIBOOT/iso/ للتمهيد المباشر.",
  "iso.add_btn": "➕ إضافة ملفات الصور",
  "iso.empty_title": "انقر لإضافة ملفات الصور (يدعم التحديد الفردي أو الدفعات)",
  "iso.empty_sub": "يدعم جميع تنسيقات Ventoy (.iso, .wim, .img, .vhd, .vhdx, إلخ)",
  "iso.summary": "تم تحديد {count} ملف(ملفات) صور",
  "iso.clear": "مسح القائمة",
  "deploy.title": "إنشاء قرص التمهيد واختبار QEMU",
  "deploy.desc_cloud": "تمهيد سحابي iPXE نقي • إعداد سريع ثنائي القسم مع برنامج ثابت للشبكة.",
  "deploy.desc_hybrid": "نواة Ventoy المدمجة + مظهر UniBoot الداكن وتوسيع iPXE.",
  "deploy.target_device": "الجهاز المستهدف:",
  "deploy.batch_target": "تم تحديد {count} محرك(محركات) USB",
  "deploy.start_create": "بدء الإنشاء",
  "deploy.start_update": "🛡️ تحديث بدون تهيئة (آمن للبيانات)",
  "deploy.batch_create": "بدء التهيئة لـ ({count} محركات)",
  "deploy.writing": "جاري كتابة حزم البرامج الثابتة...",
  "deploy.toast_switched_b": "Switched to native Mode B (1-Sec Cloud Install Disk)!",
  "deploy.toast_added_iso": "Successfully added {count} image source file(s)",
  "deploy.toast_added_demo_iso": "Added 2 demo image source files (Browser Demo)",
  "deploy.toast_select_target": "⚠️ Please select a target USB drive from the left panel first",
  ...
  "deploy.alert_success": "🎉 Deployment Successful!\n\n{msg}",
  "deploy.alert_fail": "❌ Deployment Failed:\n\n{msg}",
  "qemu.title": "اختبار محاكاة التمهيد QEMU",
  "qemu.installed": "تم اكتشاف QEMU",
  "qemu.not_installed": "لم يتم اكتشاف QEMU",
  "qemu.target": "هدف الاختبار:",
  "qemu.no_disk_warn": "⚠️ لم يتم تحديد محرك USB",
  "qemu.run_test": "▶ تشغيل اختبار QEMU",
  "qemu.launching": "⏳ جاري تشغيل جهاز QEMU الافتراضي...",
  "qemu.tip_launching": "Launching QEMU emulator...",
  "qemu.tip_deploying": "Deploying boot files, please wait until finished",
  "qemu.tip_not_installed": "QEMU emulator not found. Please install QEMU first (brew/port install qemu)",
  "qemu.tip_select_target": "Please select a target USB drive from the left panel first",
  ...
  "settings.subtitle": "التفضيلات والتكوينات",
  "settings.realtime_save": "حفظ فوري",
  "settings.tab_general": "عام",
  "settings.tab_network": "الشبكة",
  "settings.tab_uniboot": "UniBoot",
  "settings.tab_ventoy": "Ventoy",
  ...
  "settings.update_auto": "التحقق التلقائي عند البدء",
  "settings.update_manual": "يدوي فقط",
  "settings.github_proxy": "بادئة وكيل GitHub:",
  "settings.proxy_placeholder": "Default empty (Direct GitHub). Example: https://your-proxy.com/",
  "settings.test_net": "⚡ اختبار الاتصال بـ GitHub",
  "settings.testing_net": "جاري اختبار الاتصال...",
  "settings.system_proxy": "إعدادات وكيل النظام:",
  "settings.proxy_proto": "بروتوكول الوكيل:",
  "settings.proxy_direct": "اتصال مباشر",
  "settings.proxy_host": "مضيف الوكيل / IP:",
  ...
  "settings.ventoy_win11_bypass": "Bypass Windows 11 TPM/CPU/RAM Check:",
  "settings.ventoy_timeout": "Ventoy Menu Timeout (Seconds):",
  "confirm.title": "تحذير تهيئة عالي الخطورة",
  "confirm.warning_title": "⚠️ تحذير: التهيئة ستؤدي إلى محو جميع البيانات!",
  "confirm.warning_desc": "سيتم إعادة تقسيم محرك USB المحدد وتهيئته. سيتم مسح جميع الملفات الحالية بالكامل. تأكد من إمكانية النسخ الاحتياطي للبيانات الهامة!",
  "confirm.mode_title": "وضع النشر:",
  "confirm.fs_title": "نظام الملفات المستهدف:",
  "confirm.disks_title": "الأقراص المراد تهيئتها ({count}):",
  "confirm.confirm_btn": "🔥 تأكيد وبدء التهيئة",
  ...
  "ventoy_alert.default_title": "Cannot Create Mode A Disk",
  "ventoy_alert.banner_title": "💡 Missing Pre-requisites & Guidance",
  "inspector.title": "تقرير فحص أجهزة USB",
  "inspector.subtitle": "بروتوكول PHY والسرعة وتحليل الأجهزة",
  "inspector.device": "عقدة الجهاز:",
  "inspector.vendor": "البائع / العلامة التجارية:",
  "inspector.bus_speed": "بروتوكول الناقل والسرعة:",
  "inspector.fake_report": "تحليل USB 3.0 المزيف:",
  "inspector.fake_text": "⚠️ Downgraded Fake USB 3.0 (Blue/Black port, but internal protocol is USB 2.0 480Mb/s)",
  "inspector.genuine_text": "⚡ Genuine High-Speed USB 3.0/3.1 Controller",
  "inspector.smart": "صحة SMART:",
  ...
  "icon_picker.reset": "إعادة تعيين الأيقونة الافتراضية",
  "icon_picker.subtitle": "اختر مظهرًا مخصصًا للمحرك المستهدف {name}:",
  "icon_picker.usb_desc": "Classic SuperSpeed 5 Gbps Drive",
  "icon_picker.usb2_desc": "Classic High-Speed 480 Mbps Drive",
  "icon_picker.usb3_1_desc": "SuperSpeed+ 10 Gbps High Speed Drive",
  "icon_picker.usb3_2_desc": "Gen 2x2 20 Gbps Dual-Channel Drive",
...
const jaJP: TranslationDict = {
  "lang.zhCN": "简体中文 (Simplified Chinese)",
  "lang.zhTW": "繁體中文 (Traditional Chinese)",
  "lang.jaJP": "日本語 (Japanese)",
  "common.autoDetect": "自動識別 (Auto)",
  "common.langAuto": "言語 / Lang (Auto)",
  "common.lang": "言語 / Lang",
  "qemu.startSuccess": "🚀 QEMU シミュレータが正常に起動しました: {disk} ({device})",
  "qemu.backendNotReady": "⚠️ バックエンド API 未準備: Wails バインディング読み込み中",
  "qemu.demoModeStart": "[デモモード] QEMU シミュレータ起動中: {disk} ({device})",
  "qemu.startFailed": "❌ QEMU シミュレータ起動失敗: {error}",
  "disk.writingImageProgress": "イメージ書き込み中 ({fileIndex}/{totalFiles}): {currentFile} ({progress}%)",
  "settings.proxyAuthUserLabel": "認証ユーザー名 (User - オプション):",
  "settings.proxyAuthUserPlaceholder": "デフォルトは空 (認証不要の場合は空欄のまま)",
  "settings.proxyAuthPassLabel": "認証パスワード (Password - オプション):",
  "settings.proxyAuthPassPlaceholder": "デフォルトは空 (認証不要の場合は空欄のまま)",
  "settings.testingProxy": "プロキシをテスト中...",
  "settings.testProxyConn": "⚡ ネットワークプロキシ接続テスト",
  "settings.firmwareMatrixTitle": "📦 UniBoot コアファームウェア & ISO パッケージマトリクス (13項目内蔵)",
  "settings.embeddedBadge": "パッケージ内蔵 (`embed.FS`)",
  "settings.localVersion": "現在のローカルバージョン:",
  "settings.cloudRelease": "クラウド最新 Release:",
  "settings.newVersionDetected": "新バージョン検出 {version}",
  "settings.pullingFirmware": "最新ファームウェアを同期中...",
  "settings.upgradeFirmwareNow": "⚡ 今すぐファームウェアを {version} にアップグレード",
  "settings.checkSyncFirmware": "🔄 クラウドファームウェアの確認と同期",
  "settings.saveStatusEnabled": "⚡ リアルタイム保存有効",
  "settings.saveStatusApplied": "✅ 変更がリアルタイム適用されました",
  "settings.firmwareDesc.ipxeLoongarch64": "UEFI LoongArch64 (Loongson 64-bit)",
  "settings.firmwareDesc.ipxeLkrn": "Legacy BIOS USB MBR ブートカーネル (x86)",
  "settings.firmwareDesc.ipxeRiscv64Lkrn": "Legacy MBR ブートカーネル (RISC-V 64-bit)",
  "settings.firmwareDesc.ipxeRiscv32Lkrn": "Legacy MBR ブートカーネル (RISC-V 32-bit)",
  "settings.firmwareDesc.undionlyKpxe": "Legacy BIOS UNDI PXE ネットワークブートファームウェア",
  "settings.firmwareDesc.bootIpxe": "iPXE グローバルエントリースクリプト",
  "settings.firmwareDesc.unibootIpxe": "UniBoot メイン対話メニューエントリスクリプト",
  "settings.firmwareDesc.unibootIso": "UniBoot 全アーキテクチャ UEFI/BIOS ハイブリッドブート ISO イメージ",
  "settings.verifyException": "❌ 検証例外発生: {error}",
  "settings.proxyPrefix": "プロキシプレフィックス: {proxy}",
  "settings.directGitHub": "GitHub 公式直接接続 (api.github.com)",
  "settings.netTestSuccess": "✅ GitHub 接続正常 (プロトコル HTTP/2 • レイテンシ 42ms • {target})",
  "settings.directModeNotice": "💡 現在直接接続モード (ネットワークプロキシ無効)",
  "settings.proxyHostRequired": "❌ 最初にプロキシサーバーホストアドレスを入力してください",
  "settings.proxyTestSuccess": "✅ {protocol} プロキシ接続正常 ({host}:{port})",
  "settings.syncSuccessAlert": "🎉 クラウド UniBoot {tag} コアファームウェアの同期が成功しました！",
  "settings.syncSuccessShortAlert": "🎉 クラウド UniBoot コアファームウェアの同期が成功しました！",
  "settings.syncFailedAlert": "❌ ファームウェア同期失敗: {error}",
  "settings.ventoyToolchain": "🚀 Ventoy 公式ツールチェーン",
  "settings.testVentoyCli": "⚡ Ventoy CLI テスト",
  "settings.cliFormattingFlags": "🛡️ CLI フォーマットパラメータ",
  "settings.ventoyPlugins": "⚡ Ventoy プラグイン構成 (ventoy.json)",
  "app.title": "UniGoDesktop",
  "app.subtitle": "UniBoot デスクトップ起動ドライブ作成エンジン",
  "mode.cloud": "モード B (1秒極速クラウドインストール)",
  "mode.hybrid": "モード A (オールマイティデュアルモード)",
  "disk.select_title": "対象 USB ドライブの選択",
  "disk.select_desc": "リムーバブル USB ドライブのみを安全にスキャンします。システムディスクは自動保護されます。",
  "disk.single_mode": "🎯 単一選択",
  "disk.batch_mode": "📦 一括多重選択",
  "disk.select_all": "✅ すべて選択",
  "disk.clear_select": "❌ 選択解除",
  "disk.selected_count": "{count}/{total} 個選択中",
  "disk.rescan": "Rescan USB Drives",
  ...
  "disk.tag_key": "Security Key",
  "disk.tag_cdrom": "Virtual CD-ROM",
  "safe.title_cloud": "既存の Ventoy/UniBoot ドライブを検出 (モード B は ESP パーティションのみ更新)",
  "safe.desc_cloud": "モード B は UNIBOOT デュアルパーティションレイアウトを保持します。ESP パーティションを更新しても、パーティション 1 内のすべての ISO およびユーザーファイルは保護されます！",
  "safe.title_hybrid": "既存の Ventoy 起動ディスクを検出 (インプレースアップグレード)",
  "safe.desc_hybrid": "モード A はフォーマットなしですべての既存 ISO ファイルを保持し、UniBoot ダークテーマおよびクラウド起動メニューを安全に挿入します！",
  "iso.title": "💿 ローカルシステムイメージソース (ISO / IMG / WIM / VHD)",
  "iso.desc": "Ventoy / UniBoot 直接起動用に /UNIBOOT/iso/ ディレクトリへ自動コピーする ISO ファイルを追加します。",
  "iso.add_btn": "➕ イメージファイルを追加",
  "iso.empty_title": "クリックしてイメージファイルを追加 (単一または一括選択に対応)",
  "iso.empty_sub": ".iso, .wim, .img, .vhd, .vhdx, .vti, .efi, .bin, .xz, .gz, .raw 形式に対応",
  "iso.summary": "選択された {count} 個のイメージソースファイル",
  "iso.clear": "リストをクリア",
  "deploy.title": "起動ドライブ作成 & QEMU テスト",
  "deploy.desc_cloud": "純粋 iPXE クラウド起動 • マルチアーキテクチャ iPXE ネットワークファームウェア対応の超高速デュアルパーティション。",
  "deploy.desc_hybrid": "統合 Ventoy コア + UniBoot ダークテーマ & iPXE クラウド拡張、大容量 ISO イメージ対応。",
  "deploy.target_device": "対象デバイス:",
  "deploy.batch_target": "選択された {count} 個の USB ドライブ",
  "deploy.start_create": "Start Deployment",
  "deploy.start_update": "🛡️ In-Place Upgrade (Data Safe)",
  "deploy.batch_create": "Start Batch Format ({count} Drives)",
  "deploy.writing": "ブートファームウェアパッケージを書き込み中...",
  "deploy.toast_switched_b": "Switched to native Mode B (1-Sec Cloud Install Disk)!",
  "deploy.toast_added_iso": "Successfully added {count} image source file(s)",
  "deploy.toast_added_demo_iso": "Added 2 demo image source files (Browser Demo)",
  "deploy.toast_select_target": "⚠️ Please select a target USB drive from the left panel first",
  ...
  "qemu.toast_select_first": "⚠️ Please click to select a target USB drive from the left panel first!",
  "qemu.toast_not_installed": "❌ QEMU emulator not found! Please install QEMU (brew install qemu or port install qemu)",
  "settings.title": "システム設定および詳細構成",
  "settings.subtitle": "ネットワークプロキシ、GitHub 加速、iPXE ファームウェアおよび Ventoy パラメータの設定",
  "settings.realtime_save": "リアルタイム保存有効",
  "settings.tab_general": "一般設定",
  "settings.tab_network": "ネットワーク & プロキシ",
  "settings.tab_uniboot": "UniBoot",
  "settings.tab_ventoy": "Ventoy",
  "settings.language": "アプリケーション言語 (Language):",
  "settings.theme": "UI テーマ (Theme):",
  "settings.default_mode": "デフォルト作成モード:",
  "settings.default_fs": "デフォルトファイルシステム (File System):",
  "settings.app_update": "アプリ更新の確認:",
  "settings.update_auto": "起動時に自動確認 (推奨)",
  "settings.update_manual": "手動確認のみ",
  "settings.github_proxy": "GitHub リリースダウンロードプロキシ / CDN 加速:",
  "settings.proxy_placeholder": "例: https://ghproxy.com/ またはカスタム CDN ミラー",
  "settings.test_net": "⚡ GitHub 接続テスト",
  "settings.testing_net": "ネットワークをテスト中...",
  "settings.system_proxy": "システムネットワークプロキシ",
  "settings.proxy_proto": "プロキシプロトコル:",
  "settings.proxy_direct": "直接接続 (プロキシなし)",
  "settings.proxy_host": "プロキシサーバーアドレス (Host):",
  "settings.proxy_port": "プロキシポート (Port):",
  "settings.ventoy_cli_path": "Ventoy CLI 実行パス (スタンドアロン):",
  "settings.ventoy_secboot": "Secure Boot セキュアブート対応 (-s):",
  "settings.ventoy_part_style": "パーティションテーブル形式 (Partition Style):",
  "settings.ventoy_reserve": "予約領域サイズ (MB - オプション):",
  "settings.ventoy_win11_bypass": "Windows 11 TPM / CPU チェック回避:",
  "settings.ventoy_timeout": "メニュータイムアウト (秒 - 0は無制限):",
  "confirm.title": "High-Risk Format Warning",
  "confirm.warning_title": "⚠️ Warning: Formatting will erase all data!",
  "confirm.warning_desc": "The selected USB drive will be re-partitioned and formatted. All existing files will be erased completely. Ensure you have backed up important data!",
  "confirm.mode_title": "Deployment Mode:",
  ...
  "ventoy_alert.default_title": "Cannot Create Mode A Disk",
  "ventoy_alert.banner_title": "💡 Missing Pre-requisites & Guidance",
  "inspector.title": "USB 物理情報",
  "inspector.subtitle": "対象ドライブの詳細パラメータおよびコントローラチップの解析検証",
  "inspector.device": "Device Node:",
  "inspector.vendor": "コントローラチップ / ベンダー:",
  "inspector.bus_speed": "Bus Protocol & Speed:",
  "inspector.fake_report": "Fake USB 3.0 Analysis:",
  "inspector.fake_text": "⚠️ Downgraded Fake USB 3.0 (Blue/Black port, but internal protocol is USB 2.0 480Mb/s)",
  "inspector.genuine_text": "⚡ Genuine High-Speed USB 3.0/3.1 Controller",
...
const zhTW: TranslationDict = {
  ...
  "qemu.backendNotReady": "⚠️ 後端 API 尚未就緒：Wails 綁定介面載入中，請重新啟動 UniBoot 應用程序。",
  ...
  "settings.proxyAuthUserLabel": "認證用戶名 (User - 可選):",
  "settings.proxyAuthUserPlaceholder": "默認為空（若無需認證留空即可）",
  "settings.proxyAuthPassLabel": "認證密碼 (Password - 可選):",
  "settings.proxyAuthPassPlaceholder": "默認為空（若無需認證留空即可）",
  "settings.testingProxy": "正在測試代理...",
  "settings.testProxyConn": "⚡ 測試網路代理連通性",
  "settings.firmwareMatrixTitle": "📦 UniBoot 核心固件與 ISO 打包矩陣 (全量 13 項內置嵌入)",
  "settings.embeddedBadge": "已打包嵌入 (`embed.FS`)",
  "settings.localVersion": "當前本地版本:",
  "settings.cloudRelease": "雲端最新 Release:",
  "settings.newVersionDetected": "檢測到新版本 {version}",
  "settings.pullingFirmware": "正在拉取與同步最新固件...",
  "settings.upgradeFirmwareNow": "⚡ 立即升級固件至 {version}",
  "settings.checkSyncFirmware": "🔄 檢查與同步雲端固件",
  "settings.saveStatusEnabled": "⚡ 實時保存已啟用",
  "settings.saveStatusApplied": "✅ 修改已實時生效",
  "settings.firmwareDesc.ipxeLoongarch64": "UEFI LoongArch64 龍芯 64位",
  "settings.firmwareDesc.ipxeLkrn": "Legacy BIOS隨身碟 MBR 引導內核 (x86)",
  "settings.firmwareDesc.ipxeRiscv64Lkrn": "Legacy MBR 引導內核 (RISC-V 64-bit)",
  "settings.firmwareDesc.ipxeRiscv32Lkrn": "Legacy MBR 引導內核 (RISC-V 32-bit)",
  "settings.firmwareDesc.undionlyKpxe": "Legacy BIOS UNDI PXE 網路引導固件",
  "settings.firmwareDesc.bootIpxe": "iPXE 全局入口腳本",
  "settings.firmwareDesc.unibootIpxe": "UniBoot 主交互選單腳本",
  "settings.firmwareDesc.unibootIso": "UniBoot 全架構 UEFI/BIOS 混合引導 ISO 鏡像",
  "settings.verifyException": "❌ 校驗發生異常: {error}",
  "settings.proxyPrefix": "代理前綴: {proxy}",
  "settings.directGitHub": "直連 GitHub 官方 (api.github.com)",
  "settings.netTestSuccess": "✅ GitHub 連通正常 (協議 HTTP/2 • 延遲 42ms • {target})",
  "settings.directModeNotice": "💡 當前為直連模式 (未啟用網路代理)",
  "settings.proxyHostRequired": "❌ 請先輸入代理伺服器主機地址 (Host)",
  "settings.proxyTestSuccess": "✅ {protocol} 代理連通正常 ({host}:{port})",
  ...
  "disk.details": "詳細屬性",
  "disk.tag_boot": "BOOT U盤",
  "disk.tag_ssd": "移動固態",
  "disk.tag_typec": "Type-C 盤",
  "disk.tag_secure": "加密 U盤",
  "disk.tag_reader": "讀卡器",
  "disk.tag_hdd": "移動硬碟",
  "disk.tag_key": "安全鑰匙",
  "disk.tag_cdrom": "虛擬光碟",
...
const koKR: TranslationDict = {
  ...
  "common.langAuto": "언어 / Lang (Auto)",
  "common.lang": "언어 / Lang",
  "qemu.startSuccess": "🚀 QEMU 시뮬레이터가 성공적으로 시작되었습니다: {disk} ({device})",
  "qemu.backendNotReady": "⚠️ 백엔드 API가 준비되지 않았습니다. Wails 바인딩 로딩 중입니다.",
  "qemu.demoModeStart": "[데모 모드] QEMU 시뮬레이터 시작 중: {disk} ({device})",
  "qemu.startFailed": "❌ QEMU 시뮬레이터 시작 실패: {error}",
  "disk.writingImageProgress": "이미지 작성 중 ({fileIndex}/{totalFiles}): {currentFile} ({progress}%)",
  "settings.proxyAuthUserLabel": "인증 사용자 이름 (User - 선택 사항):",
  "settings.proxyAuthUserPlaceholder": "기본값은 비어 있음 (인증이 필요 없는 경우 비워 둠)",
  "settings.proxyAuthPassLabel": "인증 비밀번호 (Password - 선택 사항):",
  "settings.proxyAuthPassPlaceholder": "기본값은 비어 있음 (인증이 필요 없는 경우 비워 둠)",
  "settings.testingProxy": "프록시 테스트 중...",
  "settings.testProxyConn": "⚡ 네트워크 프록시 연결 테스트",
  "settings.firmwareMatrixTitle": "📦 UniBoot 핵심 펌웨어 및 ISO 패키지 매트릭스 (13개 항목 내장)",
  "settings.embeddedBadge": "패키지 포함됨 (`embed.FS`)",
  "settings.localVersion": "현재 로컬 버전:",
  "settings.cloudRelease": "클라우드 최신 Release:",
  "settings.newVersionDetected": "새 버전 감지됨 {version}",
  "settings.pullingFirmware": "최신 펌웨어 동기화 중...",
  "settings.upgradeFirmwareNow": "⚡ 즉시 펌웨어를 {version}(으)로 업그레이드",
  "settings.checkSyncFirmware": "🔄 클라우드 펌웨어 확인 및 동기화",
  "settings.saveStatusEnabled": "⚡ 실시간 저장 활성화됨",
  "settings.saveStatusApplied": "✅ 변경 사항 실시간 적용됨",
  "settings.firmwareDesc.ipxeLoongarch64": "UEFI LoongArch64 (Loongson 64-bit)",
  "settings.firmwareDesc.ipxeLkrn": "Legacy BIOS USB MBR 부팅 커널 (x86)",
  "settings.firmwareDesc.ipxeRiscv64Lkrn": "Legacy MBR 부팅 커널 (RISC-V 64-bit)",
  "settings.firmwareDesc.ipxeRiscv32Lkrn": "Legacy MBR 부팅 커널 (RISC-V 32-bit)",
  ...
  "settings.firmwareDesc.unibootIso": "UniBoot 전 아키텍처 UEFI/BIOS 하이브리드 부팅 ISO 이미지",
  "settings.verifyException": "❌ 검증 예외 발생: {error}",
  "settings.proxyPrefix": "프록시 접두사: {proxy}",
  "settings.directGitHub": "GitHub 공식 직접 연결 (api.github.com)",
  "settings.netTestSuccess": "✅ GitHub 연결 정상 (프로토콜 HTTP/2 • 지연 시간 42ms • {target})",
  "settings.directModeNotice": "💡 현재 직접 연결 모드 (네트워크 프록시 비활성화)",
  "settings.proxyHostRequired": "❌ 프록시 서버 호스트 주소를 먼저 입력하세요",
  "settings.proxyTestSuccess": "✅ {protocol} 프록시 연결 정상 ({host}:{port})",
  "settings.syncSuccessAlert": "🎉 클라우드 UniBoot {tag} 핵심 펌웨어가 성공적으로 동기화되었습니다!",
  "settings.syncSuccessShortAlert": "🎉 클라우드 UniBoot 핵심 펌웨어가 동기화되었습니다!",
  "settings.syncFailedAlert": "❌ 펌웨어 동기화 실패: {error}",
  "settings.ventoyToolchain": "🚀 Ventoy 공식 툴체인",
  "settings.testVentoyCli": "⚡ Ventoy CLI 테스트",
  "settings.cliFormattingFlags": "🛡️ CLI 포맷 매개변수",
  "settings.ventoyPlugins": "⚡ Ventoy 플러그인 구성 (ventoy.json)",
  "app.title": "UniGoDesktop",
  "app.subtitle": "UniBoot 데스크톱 부팅 드라이브 제작 엔진",
  "mode.cloud": "모드 B (1초 고속 클라우드 설치)",
  "mode.hybrid": "모드 A (하이브리드 디스크)",
  "disk.select_title": "대상 USB 드라이브 선택",
  "disk.select_desc": "이동식 USB 드라이브만 안전하게 스캔합니다. 시스템 디스크는 자동 보호됩니다.",
  "disk.single_mode": "🎯 단일 선택",
  "disk.batch_mode": "📦 다중 선택",
  "disk.select_all": "✅ 전체 선택",
  "disk.clear_select": "❌ 선택 해제",
  "disk.selected_count": "{count}/{total}개 선택됨",
  "disk.rescan": "Rescan USB Drives",
  ...
  "disk.tag_key": "Security Key",
  "disk.tag_cdrom": "Virtual CD-ROM",
  "safe.title_cloud": "기존 Ventoy/UniBoot 드라이브 감지됨 (모드 B는 ESP 파티션만 새로 고침)",
  "safe.desc_cloud": "모드 B는 UNIBOOT 듀얼 파티션 레이아웃을 보존합니다. ESP 파티션을 새로 고쳐도 파티션 1의 모든 ISO 및 사용자 파일은 그대로 유지됩니다!",
  "safe.title_hybrid": "기존 Ventoy 부팅 디스크 감지됨 (제자리 업그레이드)",
  "safe.desc_hybrid": "모드 A는 포맷 없이 모든 기존 ISO 파일을 보존하고, UniBoot 다크 테마 및 클라우드 부팅 메뉴를 안전하게 주입합니다!",
  "iso.title": "💿 로컬 시스템 이미지 소스 (ISO / IMG / WIM / VHD)",
  "iso.desc": "Ventoy / UniBoot 직접 부팅을 위해 /UNIBOOT/iso/ 디렉토리에 자동 복사할 ISO 파일을 추가합니다.",
  "iso.add_btn": "➕ 이미지 파일 추가",
  "iso.empty_title": "클릭하여 이미지 파일 추가 (단일 또는 일괄 선택 지원)",
  "iso.empty_sub": ".iso, .wim, .img, .vhd, .vhdx, .vti, .efi, .bin, .xz, .gz, .raw 형식 지원",
  "iso.summary": "선택된 {count}개의 이미지 소스 파일",
  "iso.clear": "목록 지우기",
  "deploy.title": "부팅 디스크 제작 및 QEMU 테스트",
  "deploy.desc_cloud": "순수 iPXE 클라우드 부팅 • 멀티 아키텍처 iPXE 네트워크 펌웨어를 지원하는 초고속 듀얼 파티션.",
  "deploy.desc_hybrid": "통합 Ventoy 코어 + UniBoot 다크 테마 및 iPXE 클라우드 확장, 대용량 ISO 이미지 지원.",
  "deploy.target_device": "대상 장치:",
  "deploy.batch_target": "선택된 {count}개의 USB 드라이브",
  "deploy.start_create": "Start Deployment",
  "deploy.start_update": "🛡️ In-Place Upgrade (Data Safe)",
  "deploy.batch_create": "Start Batch Format ({count} Drives)",
  ...
  "qemu.toast_select_first": "⚠️ Please click to select a target USB drive from the left panel first!",
  "qemu.toast_not_installed": "❌ QEMU emulator not found! Please install QEMU (brew install qemu or port install qemu)",
  "settings.title": "시스템 설정 및 구체적 구성",
  "settings.subtitle": "네트워크 프록시, GitHub 가속, iPXE 펌웨어 및 Ventoy 매개변수 구성",
  "settings.realtime_save": "실시간 저장 활성화됨",
  "settings.tab_general": "일반 설정",
  "settings.tab_network": "네트워크 및 프록시",
  "settings.tab_uniboot": "UniBoot",
  "settings.tab_ventoy": "Ventoy",
  "settings.language": "애플리케이션 언어 (Language):",
  "settings.theme": "UI 테마 (Theme):",
  "settings.default_mode": "기본 제작 모드:",
  "settings.default_fs": "기본 파일 시스템 (File System):",
  "settings.app_update": "애플리케이션 업데이트 확인:",
  "settings.update_auto": "시작 시 업데이트 자동 확인 (권장)",
  "settings.update_manual": "수동 확인 전용",
  "settings.github_proxy": "GitHub 릴리스 다운로드 프록시 / CDN 가속:",
  "settings.proxy_placeholder": "예: https://ghproxy.com/ 또는 커스텀 CDN 미러",
  "settings.test_net": "⚡ GitHub 연결 테스트",
  "settings.testing_net": "네트워크 테스트 중...",
  "settings.system_proxy": "시스템 네트워크 프록시",
  "settings.proxy_proto": "프록시 프로토콜:",
  "settings.proxy_direct": "직접 연결 (프록시 없음)",
  "settings.proxy_host": "프록시 서버 주소 (Host):",
  "settings.proxy_port": "프록시 포트 (Port):",
  "settings.ventoy_cli_path": "Ventoy CLI 실행 경로 (독립형):",
  "settings.ventoy_secboot": "Secure Boot 보안 부팅 지원 (-s):",
  "settings.ventoy_part_style": "파티션 테이블 유형 (Partition Style):",
  "settings.ventoy_reserve": "보존 공간 크기 (MB - 선택 사항):",
  "settings.ventoy_win11_bypass": "Windows 11 TPM / CPU 검사 우회:",
  "settings.ventoy_timeout": "메뉴 대기 시간 (초 - 0은 무제한):",
  "confirm.title": "High-Risk Format Warning",
  "confirm.warning_title": "⚠️ Warning: Formatting will erase all data!",
  "confirm.warning_desc": "The selected USB drive will be re-partitioned and formatted. All existing files will be erased completely. Ensure you have backed up important data!",
  "confirm.mode_title": "Deployment Mode:",
  ...
  "ventoy_alert.default_title": "Cannot Create Mode A Disk",
  "ventoy_alert.banner_title": "💡 Missing Pre-requisites & Guidance",
  "inspector.title": "USB 물리적 정보",
  "inspector.subtitle": "대상 드라이브의 상세 매개변수 및 컨트롤러 칩 분석 검사",
  "inspector.device": "Device Node:",
  "inspector.vendor": "컨트롤러 칩 / 벤더:",
  "inspector.bus_speed": "Bus Protocol & Speed:",
  "inspector.fake_report": "Fake USB 3.0 Analysis:",
  "inspector.fake_text": "⚠️ Downgraded Fake USB 3.0 (Blue/Black port, but internal protocol is USB 2.0 480Mb/s)",
  "inspector.genuine_text": "⚡ Genuine High-Speed USB 3.0/3.1 Controller",
...
const deDE: TranslationDict = {
  ...
  "disk.select_desc": "Sicheres Scannen von Wechselmedien. Systemlaufwerke sind geschützt.",
  "disk.single_mode": "🎯 Einzelauswahl",
  "disk.batch_mode": "📦 Stapelauswahl",
  "disk.select_all": "✅ Alle auswählen",
  "disk.clear_select": "❌ Auswahl aufheben",
  "disk.selected_count": "Selected {count}/{total}",
  "disk.rescan": "USB-Laufwerke neu scannen",
  "disk.scanning": "Scannen von Wechseldatenträgern...",
  "disk.no_disk": "Kein USB-Laufwerk ausgewählt",
  "disk.removable": "Wechseldatenträger",
  "disk.system_disk": "Systemlaufwerk (Geschützt)",
  "disk.fake_usb3_warning": "⚠️ Verdacht auf gefälschtes USB 3.0 (Läuft mit USB 2.0 480 Mb/s)",
  "disk.genuine_usb3": "⚡ Echte USB 3.0+ Geschwindigkeit",
  "disk.free_space": "Freier Speicher",
  "disk.change_icon": "Symbol ändern",
  "disk.hw_inspect": "HW-Inspektor",
  "disk.details": "Details",
  "disk.tag_boot": "Boot Drive",
  "disk.tag_ssd": "Portable SSD",
  "disk.tag_typec": "Type-C Drive",
  ...
  "deploy.start_update": "🛡️ Aktualisieren (Daten sicher)",
  "deploy.batch_create": "Start Batch Format ({count} Drives)",
  "deploy.writing": "Writing Boot Firmware Packages...",
  "deploy.toast_switched_b": "Switched to native Mode B (1-Sec Cloud Install Disk)!",
  "deploy.toast_added_iso": "Successfully added {count} image source file(s)",
...
const frFR: TranslationDict = {
  ...
  "settings.ventoyPlugins": "⚡ Ventoy Plugins (ventoy.json)",
  "app.title": "UniGoDesktop",
  "app.subtitle": "Moteur de création de clés USB de démarrage UniBoot Desktop",
  "mode.cloud": "Mode B (Installation Cloud en 1 sec)",
  "mode.hybrid": "Mode A (Disque Hybride Complet)",
  "disk.select_title": "Sélectionner la clé USB cible",
  "disk.select_desc": "Analyse sécurisée des disques amovibles. Les disques système sont protégés.",
  "disk.single_mode": "🎯 Sélection unique",
  "disk.batch_mode": "📦 Sélection par lot",
  "disk.select_all": "✅ Tout sélectionner",
  "disk.clear_select": "❌ Effacer la sélection",
  "disk.selected_count": "Selected {count}/{total}",
  "disk.rescan": "Re-analyser les clés USB",
  "disk.scanning": "Analyse des clés USB amovibles...",
  "disk.no_disk": "Aucune clé USB sélectionnée",
  "disk.removable": "Disque amovible",
  "disk.system_disk": "Disque système (Protégé)",
  "disk.fake_usb3_warning": "⚠️ Clé USB 3.0 suspectée fausse (Fonctionne en USB 2.0 480 Mb/s)",
  "disk.genuine_usb3": "⚡ Vitesse USB 3.0+ authentique",
  "disk.free_space": "Espace libre",
  "disk.change_icon": "Changer l’icône",
  "disk.hw_inspect": "Inspecteur matériel",
  ...
  "deploy.start_update": "🛡️ Mise à jour (Données préservées)",
  "deploy.batch_create": "Start Batch Format ({count} Drives)",
  "deploy.writing": "Writing Boot Firmware Packages...",
  "deploy.toast_switched_b": "Switched to native Mode B (1-Sec Cloud Install Disk)!",
  "deploy.toast_added_iso": "Successfully added {count} image source file(s)",
...
const esES: TranslationDict = {
  ...
  "disk.select_desc": "Escaneo seguro de unidades extraíbles. Los discos del sistema están protegidos.",
  "disk.single_mode": "🎯 Selección individual",
  "disk.batch_mode": "📦 Selección por lotes",
  "disk.select_all": "✅ Seleccionar todo",
  "disk.clear_select": "❌ Borrar selección",
  "disk.selected_count": "Selected {count}/{total}",
  "disk.rescan": "Re-escanear unidades USB",
  "disk.scanning": "Escaneando unidades USB extraíbles...",
  "disk.no_disk": "Sin unidad USB seleccionada",
  "disk.removable": "Unidad extraíble",
  "disk.system_disk": "Unidad del sistema (Protegida)",
  "disk.fake_usb3_warning": "⚠️ Sospecha de USB 3.0 falso (Funciona a velocidad USB 2.0 480 Mb/s)",
  "disk.genuine_usb3": "⚡ Velocidad USB 3.0+ auténtica",
  "disk.free_space": "Espacio libre",
  "disk.change_icon": "Cambiar icono",
  "disk.hw_inspect": "Inspector de hardware",
  ...
  "deploy.start_update": "🛡️ Actualizar (Datos seguros)",
  "deploy.batch_create": "Start Batch Format ({count} Drives)",
  "deploy.writing": "Writing Boot Firmware Packages...",
  "deploy.toast_switched_b": "Switched to native Mode B (1-Sec Cloud Install Disk)!",
  "deploy.toast_added_iso": "Successfully added {count} image source file(s)",
...
const ruRU: TranslationDict = {
  ...
  "settings.ventoyPlugins": "⚡ Ventoy Plugins (ventoy.json)",
  "app.title": "UniGoDesktop",
  "app.subtitle": "Движок создания загрузочных USB-накопителей UniBoot",
  "mode.cloud": "Режим B (Облачная установка за 1 сек)",
  "mode.hybrid": "Режим A (Полный гибридный диск)",
  "disk.select_title": "Выберите целевой USB-накопитель",
  "disk.select_desc": "Безопасное сканирование съемных накопителей. Системные диски защищены.",
  "disk.single_mode": "🎯 Одиночный выбор",
  "disk.batch_mode": "📦 Пакетный выбор",
  "disk.select_all": "✅ Выбрать все",
  "disk.clear_select": "❌ Очистить выбор",
  "disk.selected_count": "Selected {count}/{total}",
  "disk.rescan": "Обновить список USB",
  "disk.scanning": "Сканирование съемных USB-накопителей...",
  "disk.no_disk": "USB-накопитель не выбран",
  "disk.removable": "Съемный накопитель",
  "disk.system_disk": "Системный диск (Защищен)",
  "disk.fake_usb3_warning": "⚠️ Подозрение на поддельный USB 3.0 (Работает на скорости USB 2.0 480 Мб/с)",
  "disk.genuine_usb3": "⚡ Настоящая скорость USB 3.0+",
  "disk.free_space": "Свободно",
  "disk.change_icon": "Сменить иконку",
  "disk.hw_inspect": "Анализ железа",
  "disk.details": "Подробности",
  "disk.tag_boot": "Boot Drive",
  "disk.tag_ssd": "Portable SSD",
  "disk.tag_typec": "Type-C Drive",
  "disk.tag_secure": "Encrypted Drive",
  ...
  "deploy.target_device": "Target Device:",
  "deploy.batch_target": "Selected {count} USB drive(s)",
  "deploy.start_create": "Начать запись",
  "deploy.start_update": "🛡️ Обновить (Сохранить данные)",
  "deploy.batch_create": "Start Batch Format ({count} Drives)",
  "deploy.writing": "Writing Boot Firmware Packages...",
  "deploy.toast_switched_b": "Switched to native Mode B (1-Sec Cloud Install Disk)!",
  "deploy.toast_added_iso": "Successfully added {count} image source file(s)",
...
const ptBR: TranslationDict = {
  ...
  "disk.selected_count": "Selected {count}/{total}",
  "disk.rescan": "Rescan USB Drives",
  "disk.scanning": "Escaneando drives USB removíveis...",
  "disk.no_disk": "No USB Drive Selected",
  "disk.removable": "Removable Drive",
  "disk.system_disk": "System Drive (Protected)",
  "disk.fake_usb3_warning": "⚠️ Suspected Downgraded Fake USB 3.0 Drive (Runs at USB 2.0 480 Mb/s)",
  ...
  "deploy.target_device": "Target Device:",
  "deploy.batch_target": "Selected {count} USB drive(s)",
  "deploy.start_create": "Iniciar criação",
  "deploy.start_update": "🛡️ In-Place Upgrade (Data Safe)",
  "deploy.batch_create": "Start Batch Format ({count} Drives)",
  "deploy.writing": "Writing Boot Firmware Packages...",
  "deploy.toast_switched_b": "Switched to native Mode B (1-Sec Cloud Install Disk)!",
...
const itIT: TranslationDict = {
  ...
  "disk.selected_count": "Selected {count}/{total}",
  "disk.rescan": "Rescan USB Drives",
  "disk.scanning": "Scansione delle unita USB rimovibili...",
  "disk.no_disk": "No USB Drive Selected",
  "disk.removable": "Removable Drive",
  "disk.system_disk": "System Drive (Protected)",
  "disk.fake_usb3_warning": "⚠️ Suspected Downgraded Fake USB 3.0 Drive (Runs at USB 2.0 480 Mb/s)",
...
const plPL: TranslationDict = {
  ...
  "disk.selected_count": "Selected {count}/{total}",
  "disk.rescan": "Rescan USB Drives",
  "disk.scanning": "Skanowanie dysków wymiennych USB...",
  "disk.no_disk": "No USB Drive Selected",
  "disk.removable": "Removable Drive",
  "disk.system_disk": "System Drive (Protected)",
  "disk.fake_usb3_warning": "⚠️ Suspected Downgraded Fake USB 3.0 Drive (Runs at USB 2.0 480 Mb/s)",
