...
export const enUs: TranslationDict = {
  ...
  "settings.realtime_save": "Changes saved in real-time",
  "settings.saveStatusEnabled": "⚡ Saving changes...",
  "settings.saveStatusApplied": "✅ Changes applied",
  ...
  "settings.github_proxy_title": "GitHub Mirror Acceleration",
  ...
  "settings.proxy_direct": "Direct Mode",
  "settings.proxyDirect": "Direct (Disabled)",
  "settings.proxy_host": "Proxy Host",
  "settings.proxy_port": "Port",
  "settings.proxyAuthUserLabel": "Username (Optional)",
  "settings.proxyAuthUserPlaceholder": "Leave blank if no auth required",
  "settings.proxyAuthPassLabel": "Password (Optional)",
  "settings.proxyAuthPassPlaceholder": "Leave blank if no auth required",
  "settings.directModeNotice": "💡 Direct mode active (proxy disabled)",
  "settings.proxyHostRequired": "❌ Please enter proxy host address first",
  "settings.testingProxy": "Testing proxy...",
  "settings.testProxyConn": "⚡ Test Proxy Connectivity",
