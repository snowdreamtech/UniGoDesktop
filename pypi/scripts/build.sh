...
mkdir -p "${PYPI_DIR}/snowdreamtech_unigodesktop/bin"
# Copy README
...
PLATFORMS="
unigodesktop_darwin_arm64_v8.0|macosx_11_0_arm64|unigo
unigodesktop_darwin_amd64_v1|macosx_10_9_x86_64|unigo
unigodesktop_linux_amd64_v1|manylinux2014_x86_64|unigo
unigodesktop_linux_arm64_v8.0|manylinux2014_aarch64|unigo
unigodesktop_linux_386_sse2|manylinux2014_i686|unigo
unigodesktop_linux_arm_7|manylinux2014_armv7l|unigo
unigodesktop_linux_ppc64le_power8|manylinux2014_ppc64le|unigo
unigodesktop_linux_s390x|manylinux2014_s390x|unigo
unigodesktop_windows_amd64_v1|win_amd64|unigodesktop.exe
unigodesktop_windows_arm64_v8.0|win_arm64|unigodesktop.exe
unigodesktop_windows_386_sse2|win32|unigodesktop.exe
"

echo "${PLATFORMS}" | grep -v '^$' | while IFS='|' read -r _dist_subdir _pypi_plat _binary; do
  _src_binary="${DIST_DIR}/${_dist_subdir}/${_binary}"
  _dst_binary="snowdreamtech_unigodesktop/bin/${_binary}"
  ...
  rm -f snowdreamtech_unigodesktop/bin/*
